...
export const useAuthLazyFetch = (request: any, options: any | undefined | null) => {
    ...
    let token =  'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6InN3ZXRoYS5zYW5rYXRpQDUwMGFwcHMuY29tIiwidGVuYW50X2lkIjozMDc2NCwidXNlcl9pZCI6MTgyNTY3LCJzdWJzY3JpYmVkIjoibm8iLCJleHAiOiIxNjgxMjA0MzQ5IiwiZW52IjoiYXAxIn0.rR3z8RLse0XU-6Hu0WGby9oAT2ySLK8cF5XkSBtAiYc'
